...
import { addItem, removeOneItem, removeAllItem } from "../redux/slices/cartSlice";
...
const CartItem: React.FC<CartItemProps> = ({ id, title, type, price, quantity, size, imageUrl }) => {
  ...
  const onClickMinus = () => dispatch(removeOneItem(id));
